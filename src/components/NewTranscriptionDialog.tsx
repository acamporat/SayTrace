              ...
              <>
                <div className="recording-confirmation__state is-on">
                  ...
                  <span>
                    ...
                    <small>
                      The entire main display will be recorded and stored
                      locally, including visible notifications and other apps.
                    </small>
                  </span>
                </div>
                <ul
                ...
                <label className="recording-confirmation__acknowledgement">
                  ...
                  />
                  <span>
                    I understand that the entire main display—not just the
            ...
            <div className="new-dialog__choices">
              ...
              >
                ...
                <span>
                  ...
                  <small>
                    {captureScreen
                      ? "Audio + main display (review before starting)"
            ...
            >
              <label className="new-dialog__screen-toggle">
                ...
                <span>
                  ...
                  <small>
                    On by default. Main-display video is stored locally.
                  </small>
                </span>
              </label>
              {captureScreen ? (
                ...
                >
                  ...
                  >
                    <Info size={18} aria-hidden="true" />
                    <p>
                      Everything visible on the main display—including
