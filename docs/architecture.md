...
2. When separately authorized, a thread-owned FFmpeg `gdigrab` process records
   the whole desktop and cursor at low frame rate into independently finalized
   video segments. Pause finalizes the current segment; resume starts another.
